      ...
      body: SafeArea(
        ...
        children: <Widget>[
          SearchTextFieldWidget(
            margin: EdgeInsets.all(Constant.MARGIN_LEFT),
            hintText: hintText,
            onTab: () {
...
class _GroupWidgetState extends State<_GroupWidget> {
  ...
  Widget _getBody() {
    if (list == null) {
      return Container(
        child: Image.asset(Constant.imagePath + 'ic_group_top.png'),
      );
    }
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        if (index == 0) {
          return Image.asset(Constant.imagePath + 'ic_group_top.png');
        }

        Subject bean = list[index - 1];
        return Padding(
          padding: const EdgeInsets.only(
              right: Constant.MARGIN_LEFT, left: 6.0, top: 13.0),
